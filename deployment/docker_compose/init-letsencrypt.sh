...
$COMPOSE_CMD -f docker-compose.prod.yml run  --name bsmart-stack --rm --entrypoint "\
...
echo "### Starting nginx ..."
$COMPOSE_CMD -f docker-compose.prod.yml -p bsmart-stack up --force-recreate -d nginx
echo
...
$COMPOSE_CMD -f docker-compose.prod.yml -p bsmart-stack up --force-recreate -d
