...
$COMPOSE_CMD -f docker-compose.dev.yml run  --name danswer-stack --rm --entrypoint "\
...
echo "### Starting nginx ..."
$COMPOSE_CMD -f docker-compose.dev.yml -p danswer-stack up --force-recreate -d nginx
echo
...
$COMPOSE_CMD -f docker-compose.dev.yml -p danswer-stack up --force-recreate -d
