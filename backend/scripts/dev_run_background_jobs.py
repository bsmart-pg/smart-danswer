...
def run_jobs() -> None:
    ...
    cmd_worker_primary = [
        "celery",
        "-A",
        "bsmart.background.celery.versioned_apps.primary",
        "worker",
        "--pool=threads",
        "--concurrency=6",
    ...
    cmd_worker_light = [
        "celery",
        "-A",
        "bsmart.background.celery.versioned_apps.light",
        "worker",
        "--pool=threads",
        "--concurrency=16",
    ...
    cmd_worker_heavy = [
        "celery",
        "-A",
        "bsmart.background.celery.versioned_apps.heavy",
        "worker",
        "--pool=threads",
        "--concurrency=6",
        "--prefetch-multiplier=1",
    ...
    cmd_worker_indexing = [
        "celery",
        "-A",
        "bsmart.background.celery.versioned_apps.indexing",
        "worker",
        "--pool=threads",
        "--concurrency=1",
        "--prefetch-multiplier=1",
