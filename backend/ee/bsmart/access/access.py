...
from bsmart.access.access import (
    _get_access_for_documents as get_access_for_documents_without_groups,
)
from bsmart.access.access import _get_acl_for_user as get_acl_for_user_without_groups
from bsmart.access.models import DocumentAccess
from bsmart.access.utils import prefix_external_group
from bsmart.access.utils import prefix_user_group
from bsmart.db.document import get_documents_by_ids
from bsmart.db.models import User
from ee.bsmart.db.external_perm import fetch_external_groups_for_user
from ee.bsmart.db.user_group import fetch_user_groups_for_documents
...
def _get_access_for_documents(
    ...
    for document_id, non_ee_access in non_ee_access_dict.items():
        ...
        # then it's given the same access level as if it were marked public within Bsmart
...
def _get_acl_for_user(user: User | None, db_session: Session) -> set[str]:
    ...
    NOTE: is imported in bsmart.access.access by `fetch_versioned_implementation`
    DO NOT REMOVE."""
