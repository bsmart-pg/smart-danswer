...
from ee.bsmart.configs.app_configs import SAML_CONF_DIR
from ee.bsmart.db.saml import expire_saml_account
from ee.bsmart.db.saml import get_saml_account
from ee.bsmart.db.saml import upsert_saml_account
from ee.bsmart.utils.secrets import encrypt_string
from ee.bsmart.utils.secrets import extract_hashed_cookie
...
async def saml_login_callback(
    ...
    # Redirect to main Bsmart search page
