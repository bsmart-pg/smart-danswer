...
from bsmart.chat.process_message import ChatPacketStream
from bsmart.chat.process_message import stream_chat_message_objects
...
from ee.bsmart.server.query_and_chat.models import BasicCreateChatMessageRequest
from ee.bsmart.server.query_and_chat.models import (
    BasicCreateChatMessageWithHistoryRequest,
)
from ee.bsmart.server.query_and_chat.models import ChatBasicResponse
from ee.bsmart.server.query_and_chat.models import SimpleDoc
...
def handle_send_message_simple_with_history(
    ...
    max_history_tokens = int(input_tokens * BSMART_BOT_TARGET_CHUNK_PERCENTAGE)
