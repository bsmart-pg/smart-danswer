...
from bsmart.configs.app_configs import ENABLE_EXPENSIVE_EXPERT_CALLS
...
from bsmart.connectors.slack.utils import get_message_link
from bsmart.connectors.slack.utils import make_paginated_slack_api_call_w_retries
from bsmart.connectors.slack.utils import make_slack_api_call_w_retries
...
def default_msg_filter(message: MessageType) -> bool:
    ...
    if message.get("bot_id") or message.get("app_id"):
        if message.get("bot_profile", {}).get("name") == "BsmartConnector":
            return False
        return True
