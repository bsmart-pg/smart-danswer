...
from bsmart.configs.app_configs import WEB_CONNECTOR_OAUTH_CLIENT_ID
from bsmart.configs.app_configs import WEB_CONNECTOR_OAUTH_CLIENT_SECRET
from bsmart.configs.app_configs import WEB_CONNECTOR_OAUTH_TOKEN_URL
from bsmart.configs.app_configs import WEB_CONNECTOR_VALIDATE_URLS
...
from bsmart.file_processing.html_utils import web_html_cleanup
from bsmart.utils.logger import setup_logger
from bsmart.utils.sitemap import list_pages_for_site
...
if __name__ == "__main__":
    connector = WebConnector("https://docs.bsmart.dev/")
