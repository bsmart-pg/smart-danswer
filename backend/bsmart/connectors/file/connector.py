...
from bsmart.file_processing.extract_file_text import check_file_ext_is_valid
from bsmart.file_processing.extract_file_text import detect_encoding
from bsmart.file_processing.extract_file_text import extract_file_text
from bsmart.file_processing.extract_file_text import get_file_ext
from bsmart.file_processing.extract_file_text import is_text_file_extension
from bsmart.file_processing.extract_file_text import load_files_from_zip
from bsmart.file_processing.extract_file_text import read_pdf_file
from bsmart.file_processing.extract_file_text import read_text_file
...
def _process_file(
    ...
    if is_text_file_extension(file_name):
        ...
        file_content_raw, file_metadata = read_text_file(
            file, encoding=encoding, ignore_bsmart_metadata=False
        )
    ...
    # Metadata tags separate from the Bsmart specific fields
    metadata_tags = {
        k: v
