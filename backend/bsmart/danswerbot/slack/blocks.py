...
from bsmart.configs.constants import SearchFeedbackType
from bsmart.configs.bsmartbot_configs import BSMART_BOT_NUM_DOCS_TO_DISPLAY
from bsmart.context.search.models import SavedSearchDoc
from bsmart.bsmartbot.slack.constants import CONTINUE_IN_WEB_UI_ACTION_ID
...
from bsmart.bsmartbot.slack.formatting import format_slack_message
from bsmart.bsmartbot.slack.icons import source_to_github_img_link
from bsmart.bsmartbot.slack.models import SlackMessageInfo
from bsmart.bsmartbot.slack.utils import build_continue_in_web_ui_id
from bsmart.bsmartbot.slack.utils import build_feedback_id
from bsmart.bsmartbot.slack.utils import remove_slack_text_interactions
from bsmart.bsmartbot.slack.utils import translate_vespa_highlight_to_slack
from bsmart.db.chat import get_chat_session_by_message_id
from bsmart.db.engine import get_session_with_tenant
from bsmart.db.models import ChannelConfig
from bsmart.db.models import Persona
from bsmart.one_shot_answer.models import OneShotQAResponse
from bsmart.utils.text_processing import decode_escapes
...
def _build_documents_blocks(
    ...
    message_id: int | None,
    num_docs_to_display: int = BSMART_BOT_NUM_DOCS_TO_DISPLAY,
) -> list[Block]:
    header_text = (
...
def build_slack_response_blocks(
    ...
    """
    # If called with the BsmartBot slash command, the question is lost so we have to reshow it
