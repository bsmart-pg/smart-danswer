...
from bsmart.configs.app_configs import DISABLE_INDEX_UPDATE_ON_SWAP
from bsmart.configs.app_configs import MANAGED_VESPA
from bsmart.configs.constants import KV_REINDEX_KEY
from bsmart.configs.constants import KV_SEARCH_SETTINGS
from bsmart.configs.model_configs import FAST_GEN_AI_MODEL_VERSION
from bsmart.configs.model_configs import GEN_AI_API_KEY
from bsmart.configs.model_configs import GEN_AI_MODEL_VERSION
from bsmart.context.search.models import SavedSearchSettings
from bsmart.context.search.retrieval.search_runner import download_nltk_data
from bsmart.db.connector import check_connectors_exist
from bsmart.db.connector import create_initial_default_connector
from bsmart.db.connector_credential_pair import associate_default_cc_pair
from bsmart.db.connector_credential_pair import get_connector_credential_pairs
from bsmart.db.connector_credential_pair import resync_cc_pair
from bsmart.db.credentials import create_initial_public_credential
from bsmart.db.document import check_docs_exist
from bsmart.db.index_attempt import cancel_indexing_attempts_past_model
from bsmart.db.index_attempt import expire_index_attempts
from bsmart.db.llm import fetch_default_provider
from bsmart.db.llm import update_default_provider
from bsmart.db.llm import upsert_llm_provider
from bsmart.db.persona import delete_old_default_personas
...
from bsmart.db.search_settings import update_current_search_settings
from bsmart.db.search_settings import update_secondary_search_settings
...
from bsmart.natural_language_processing.search_nlp_models import warm_up_cross_encoder
from bsmart.seeding.load_docs import seed_initial_documents
from bsmart.seeding.load_yamls import load_chat_yamls
from bsmart.server.manage.llm.models import LLMProviderUpsertRequest
from bsmart.server.settings.store import load_settings
from bsmart.server.settings.store import store_settings
from bsmart.tools.built_in_tools import auto_add_search_tool_to_personas
from bsmart.tools.built_in_tools import load_builtin_tools
from bsmart.tools.built_in_tools import refresh_built_in_tools_cache
from bsmart.utils.gpu_utils import gpu_status_request
...
def setup_bsmart(
    ...
    """
    Setup Bsmart for a particular tenant. In the Single Tenant case, it will set it up for the default schema
...
def setup_multitenant_bsmart() -> None:
