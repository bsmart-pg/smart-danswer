...
from bsmart.access.models import default_public_access
from bsmart.configs.constants import DEFAULT_BOOST
from bsmart.configs.constants import DocumentSource
from bsmart.configs.constants import KV_DOCUMENTS_SEEDED_KEY
...
from bsmart.db.credentials import PUBLIC_CREDENTIAL_ID
...
from bsmart.db.index_attempt import mock_successful_index_attempt
...
from bsmart.indexing.indexing_pipeline import index_doc_batch_prepare
...
def seed_initial_documents(
    ...
    connector_data = ConnectorBase(
        ...
        connector_specific_config={
            "base_url": "https://docs.bsmart.dev/more/use_cases",
