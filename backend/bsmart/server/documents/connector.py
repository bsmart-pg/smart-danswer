...
from bsmart.auth.users import current_curator_or_admin_user
from bsmart.auth.users import current_user
from bsmart.background.celery.celery_utils import get_deletion_attempt_snapshot
from bsmart.background.celery.versioned_apps.primary import app as primary_app
from bsmart.configs.app_configs import ENABLED_CONNECTOR_TYPES
from bsmart.configs.constants import BsmartCeleryPriority
from bsmart.configs.constants import DocumentSource
from bsmart.configs.constants import FileOrigin
from bsmart.connectors.google_utils.google_auth import (
    get_google_oauth_creds,
)
from bsmart.connectors.google_utils.google_kv import (
...
from bsmart.connectors.google_utils.google_kv import get_auth_url
from bsmart.connectors.google_utils.google_kv import (
    get_google_app_cred,
)
from bsmart.connectors.google_utils.google_kv import (
...
from bsmart.connectors.google_utils.google_kv import verify_csrf
from bsmart.connectors.google_utils.shared_constants import (
    DB_CREDENTIALS_DICT_TOKEN_KEY,
)
from bsmart.db.connector import create_connector
from bsmart.db.connector import delete_connector
from bsmart.db.connector import fetch_connector_by_id
from bsmart.db.connector import fetch_connectors
from bsmart.db.connector import get_connector_credential_ids
from bsmart.db.connector import mark_ccpair_with_indexing_trigger
from bsmart.db.connector import update_connector
from bsmart.db.connector_credential_pair import add_credential_to_connector
from bsmart.db.connector_credential_pair import get_cc_pair_groups_for_ids
from bsmart.db.connector_credential_pair import get_connector_credential_pair
from bsmart.db.connector_credential_pair import get_connector_credential_pairs
from bsmart.db.credentials import cleanup_gmail_credentials
from bsmart.db.credentials import cleanup_google_drive_credentials
from bsmart.db.credentials import create_credential
from bsmart.db.credentials import delete_service_account_credentials
from bsmart.db.credentials import fetch_credential_by_id
from bsmart.db.deletion_attempt import check_deletion_attempt_is_allowed
from bsmart.db.document import get_document_counts_for_cc_pairs
...
from bsmart.db.enums import IndexingMode
from bsmart.db.index_attempt import get_index_attempts_for_cc_pair
from bsmart.db.index_attempt import get_latest_index_attempt_for_cc_pair_id
from bsmart.db.index_attempt import get_latest_index_attempts
from bsmart.db.index_attempt import get_latest_index_attempts_by_status
from bsmart.db.models import IndexingStatus
...
from bsmart.file_store.file_store import get_default_file_store
from bsmart.key_value_store.interface import KvKeyNotFoundError
from bsmart.redis.redis_connector import RedisConnector
from bsmart.server.documents.models import AuthStatus
from bsmart.server.documents.models import AuthUrl
from bsmart.server.documents.models import ConnectorCredentialPairIdentifier
from bsmart.server.documents.models import ConnectorIndexingStatus
from bsmart.server.documents.models import ConnectorSnapshot
from bsmart.server.documents.models import ConnectorUpdateRequest
from bsmart.server.documents.models import CredentialBase
from bsmart.server.documents.models import CredentialSnapshot
from bsmart.server.documents.models import FailedConnectorIndexingStatus
from bsmart.server.documents.models import FileUploadResponse
from bsmart.server.documents.models import GDriveCallback
from bsmart.server.documents.models import GmailCallback
from bsmart.server.documents.models import GoogleAppCredentials
from bsmart.server.documents.models import GoogleServiceAccountCredentialRequest
from bsmart.server.documents.models import GoogleServiceAccountKey
from bsmart.server.documents.models import IndexAttemptSnapshot
from bsmart.server.documents.models import ObjectCreationIdResponse
from bsmart.server.documents.models import RunConnectorRequest
from bsmart.server.models import StatusResponse
from bsmart.utils.logger import setup_logger
from bsmart.utils.variable_functionality import fetch_ee_implementation_or_noop
...
def create_connector_from_model(
    ...
    try:
        ...
        fetch_ee_implementation_or_noop(
            "bsmart.db.user_group", "validate_user_creation_permissions", None
        )(
            db_session=db_session,
            user=user,
...
def connector_run_once(
    ...
    primary_app.send_task(
        "check_for_indexing",
        priority=BsmartCeleryPriority.HIGH,
