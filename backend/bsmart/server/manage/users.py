...
from bsmart.auth.invited_users import get_invited_users
from bsmart.auth.invited_users import write_invited_users
from bsmart.auth.noauth_user import fetch_no_auth_user
from bsmart.auth.noauth_user import set_no_auth_user_preferences
from bsmart.auth.schemas import UserRole
from bsmart.auth.schemas import UserStatus
...
from bsmart.auth.users import optional_user
from bsmart.configs.app_configs import AUTH_TYPE
from bsmart.configs.app_configs import ENABLE_EMAIL_INVITES
from bsmart.configs.app_configs import SESSION_EXPIRE_TIME_SECONDS
from bsmart.configs.app_configs import VALID_EMAIL_DOMAINS
from bsmart.configs.constants import AuthType
from bsmart.db.api_key import is_api_key_email_address
from bsmart.db.auth import get_total_users_count
from bsmart.db.engine import CURRENT_TENANT_ID_CONTEXTVAR
from bsmart.db.engine import get_session
from bsmart.db.models import AccessToken
from bsmart.db.models import DocumentSet__User
from bsmart.db.models import Persona__User
from bsmart.db.models import SamlAccount
from bsmart.db.models import User
from bsmart.db.models import User__UserGroup
from bsmart.db.users import get_user_by_email
from bsmart.db.users import list_users
from bsmart.db.users import validate_user_role_update
from bsmart.key_value_store.factory import get_kv_store
from bsmart.server.manage.models import AllUsersResponse
from bsmart.server.manage.models import AutoScrollRequest
from bsmart.server.manage.models import UserByEmail
from bsmart.server.manage.models import UserInfo
from bsmart.server.manage.models import UserPreferences
from bsmart.server.manage.models import UserRoleResponse
from bsmart.server.manage.models import UserRoleUpdateRequest
from bsmart.server.models import FullUserSnapshot
from bsmart.server.models import InvitedUserSnapshot
from bsmart.server.models import MinimalUserSnapshot
from bsmart.server.utils import send_user_email_invite
...
from ee.bsmart.configs.app_configs import SUPER_USERS
...
def bulk_invite_users(
    ...
    if MULTI_TENANT:
        try:
            fetch_ee_implementation_or_noop(
                "bsmart.server.tenants.provisioning", "add_users_to_tenant", None
            ...
            if isinstance(e.orig, UniqueViolation):
                raise HTTPException(
                    status_code=400,
                    detail="User has already been invited to a Bsmart organization",
                )
            raise
    ...
    try:
        ...
        fetch_ee_implementation_or_noop(
            "bsmart.server.tenants.billing", "register_tenant_users", None
        ...
        fetch_ee_implementation_or_noop(
            "bsmart.server.tenants.user_mapping", "remove_users_from_tenant", None
        )(normalized_emails, tenant_id)
        raise e
...
def verify_user_logged_in(
    ...
    organization_name = fetch_ee_implementation_or_noop(
        "bsmart.server.tenants.user_mapping", "get_tenant_id_for_email", None
    )(user.email)
