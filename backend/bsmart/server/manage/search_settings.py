...
from bsmart.context.search.models import SearchSettingsCreationRequest
...
from bsmart.db.search_settings import create_search_settings
from bsmart.db.search_settings import delete_search_settings
from bsmart.db.search_settings import get_current_search_settings
from bsmart.db.search_settings import get_embedding_provider_from_provider_type
...
from bsmart.db.search_settings import update_search_settings_status
from bsmart.document_index.factory import get_default_document_index
from bsmart.file_processing.unstructured import delete_unstructured_api_key
from bsmart.file_processing.unstructured import get_unstructured_api_key
from bsmart.file_processing.unstructured import update_unstructured_api_key
from bsmart.natural_language_processing.search_nlp_models import clean_model_name
from bsmart.server.manage.embedding.models import SearchSettingsDeleteRequest
from bsmart.server.manage.models import FullModelVersionResponse
from bsmart.server.models import IdReturn
...
def set_new_search_settings(
    ...
    if search_settings_new.index_name is None:
        ...
        index_name = f"bsmart_chunk_{clean_model_name(search_settings_new.model_name)}"
        if (
