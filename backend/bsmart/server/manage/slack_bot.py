...
from bsmart.bsmartbot.slack.config import validate_channel_name
from bsmart.db.constants import SLACK_BOT_PERSONA_PREFIX
...
from bsmart.db.slack_bot import fetch_slack_bot
from bsmart.db.slack_bot import fetch_slack_bots
from bsmart.db.slack_bot import insert_slack_bot
from bsmart.db.slack_bot import remove_slack_bot
from bsmart.db.slack_bot import update_slack_bot
from bsmart.db.slack_channel_config import create_slack_channel_persona
from bsmart.db.slack_channel_config import fetch_slack_channel_config
from bsmart.db.slack_channel_config import fetch_slack_channel_configs
from bsmart.db.slack_channel_config import insert_slack_channel_config
from bsmart.db.slack_channel_config import remove_slack_channel_config
from bsmart.db.slack_channel_config import update_slack_channel_config
from bsmart.server.manage.models import SlackBot
from bsmart.server.manage.models import SlackBotCreationRequest
from bsmart.server.manage.models import SlackChannelConfig
from bsmart.server.manage.models import SlackChannelConfigCreationRequest
...
def _form_channel_config(
    ...
    if respond_tag_only and respond_member_group_list:
        raise ValueError(
            "Cannot set BsmartBot to only respond to tags only and "
