...
from bsmart.configs.app_configs import AZURE_DALLE_API_BASE
from bsmart.configs.app_configs import AZURE_DALLE_API_KEY
from bsmart.configs.app_configs import AZURE_DALLE_API_VERSION
from bsmart.configs.app_configs import AZURE_DALLE_DEPLOYMENT_NAME
from bsmart.configs.chat_configs import BING_API_KEY
from bsmart.configs.model_configs import GEN_AI_TEMPERATURE
...
from bsmart.db.llm import fetch_existing_llm_providers
...
from bsmart.tools.built_in_tools import get_built_in_tool_by_id
from bsmart.tools.models import DynamicSchemaInfo
...
from bsmart.tools.utils import compute_all_tool_tokens
from bsmart.tools.utils import explicit_tool_calling_supported
from bsmart.utils.headers import header_dict_to_header_list
    ...
    for db_tool_model in persona.tools:
        if db_tool_model.in_code_tool_id:
            ...
            # Handle Internet Search Tool
                ...
                if not BING_API_KEY:
                    raise ValueError(
                        "Internet search tool requires a Bing API key, please contact your Bsmart admin to get it added!"
                    )
                tool_dict[db_tool_model.id] = [
                    InternetSearchTool(
