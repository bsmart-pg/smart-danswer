...
from bsmart.configs.constants import POSTGRES_CELERY_BEAT_APP_NAME
...
celery_app.config_from_object("bsmart.background.celery.configs.beat")
    ...
    def _update_tenant_tasks(self) -> None:
        ...
        try:
            ...
            tasks_to_schedule = fetch_versioned_implementation(
                "bsmart.background.celery.tasks.beat_schedule", "get_tasks_to_schedule"
            )
