...
from bsmart.background.celery.apps.task_formatters import CeleryTaskColoredFormatter
from bsmart.background.celery.apps.task_formatters import CeleryTaskPlainFormatter
...
from bsmart.document_index.vespa_constants import VESPA_CONFIG_SERVER_URL
...
from bsmart.utils.logger import ColoredFormatter
from bsmart.utils.logger import PlainFormatter
...
def on_secondary_worker_init(sender: Any, **kwargs: Any) -> None:
    ...
    while True:
        if r.exists(BsmartRedisLocks.PRIMARY_WORKER):
            break
