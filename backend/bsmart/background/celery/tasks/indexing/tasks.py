...
from bsmart.background.indexing.job_client import SimpleJobClient
from bsmart.background.indexing.run_indexing import run_indexing_entrypoint
from bsmart.configs.app_configs import DISABLE_INDEX_UPDATE_ON_SWAP
from bsmart.configs.constants import CELERY_INDEXING_LOCK_TIMEOUT
from bsmart.configs.constants import CELERY_VESPA_SYNC_BEAT_LOCK_TIMEOUT
from bsmart.configs.constants import BSMART_REDIS_FUNCTION_LOCK_PREFIX
...
from bsmart.db.connector_credential_pair import fetch_connector_credential_pairs
from bsmart.db.connector_credential_pair import get_connector_credential_pair_from_id
from bsmart.db.engine import get_db_current_time
from bsmart.db.engine import get_session_with_tenant
from bsmart.db.enums import ConnectorCredentialPairStatus
from bsmart.db.enums import IndexingMode
from bsmart.db.enums import IndexingStatus
from bsmart.db.enums import IndexModelStatus
from bsmart.db.index_attempt import create_index_attempt
from bsmart.db.index_attempt import delete_index_attempt
from bsmart.db.index_attempt import get_all_index_attempts_by_status
from bsmart.db.index_attempt import get_index_attempt
from bsmart.db.index_attempt import get_last_attempt_for_cc_pair
from bsmart.db.index_attempt import mark_attempt_canceled
from bsmart.db.index_attempt import mark_attempt_failed
from bsmart.db.models import ConnectorCredentialPair
from bsmart.db.models import IndexAttempt
from bsmart.db.models import SearchSettings
from bsmart.db.search_settings import get_active_search_settings
from bsmart.db.search_settings import get_current_search_settings
from bsmart.db.swap_index import check_index_swap
from bsmart.indexing.indexing_heartbeat import IndexingHeartbeatInterface
...
from bsmart.redis.redis_connector_index import RedisConnectorIndexPayload
...
def check_for_indexing(self: Task, *, tenant_id: str | None) -> int | None:
    ...
    lock_beat: RedisLock = r.lock(
        BsmartRedisLocks.CHECK_INDEXING_BEAT_LOCK,
...
def try_creating_indexing_task(
    ...
    lock: RedisLock = r.lock(
        BSMART_REDIS_FUNCTION_LOCK_PREFIX + "try_creating_indexing_task",
    ...
    try:
        ...
        result = celery_app.send_task(
            ...
            queue=BsmartCeleryQueues.CONNECTOR_INDEXING,
            task_id=custom_task_id,
            priority=BsmartCeleryPriority.MEDIUM,
        )
        if not result:
