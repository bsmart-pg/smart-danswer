...
from bsmart.configs.constants import CELERY_EXTERNAL_GROUP_SYNC_LOCK_TIMEOUT
...
from bsmart.db.connector import mark_cc_pair_as_external_group_synced
...
from bsmart.redis.redis_connector_ext_group_sync import (
...
from ee.bsmart.db.external_perm import ExternalUserGroup
from ee.bsmart.db.external_perm import replace_user__ext_group_for_cc_pair
from ee.bsmart.external_permissions.sync_params import EXTERNAL_GROUP_SYNC_PERIODS
from ee.bsmart.external_permissions.sync_params import GROUP_PERMISSIONS_FUNC_MAP
...
def check_for_external_group_sync(self: Task, *, tenant_id: str | None) -> None:
    ...
    lock_beat = r.lock(
        BsmartRedisLocks.CHECK_CONNECTOR_EXTERNAL_GROUP_SYNC_BEAT_LOCK,
...
def try_creating_external_group_sync_task(
    ...
    lock = r.lock(
        BSMART_REDIS_FUNCTION_LOCK_PREFIX + "try_generate_external_group_sync_tasks",
    ...
    try:
        ...
        result = app.send_task(
            ...
            queue=BsmartCeleryQueues.CONNECTOR_EXTERNAL_GROUP_SYNC,
...
def connector_external_group_sync_generator_task(
    ...
    lock: RedisLock = r.lock(
        BsmartRedisLocks.CONNECTOR_EXTERNAL_GROUP_SYNC_LOCK_PREFIX
