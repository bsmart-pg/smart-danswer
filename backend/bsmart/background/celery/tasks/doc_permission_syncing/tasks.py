...
from bsmart.access.models import DocExternalAccess
from bsmart.background.celery.apps.app_base import task_logger
from bsmart.configs.app_configs import JOB_TIMEOUT
from bsmart.configs.constants import CELERY_PERMISSIONS_SYNC_LOCK_TIMEOUT
...
from bsmart.db.users import batch_add_ext_perm_user_if_not_exists
...
from bsmart.utils.logger import doc_permission_sync_ctx
from bsmart.utils.logger import setup_logger
from ee.bsmart.db.connector_credential_pair import get_all_auto_sync_cc_pairs
from ee.bsmart.db.document import upsert_document_external_perms
from ee.bsmart.external_permissions.sync_params import DOC_PERMISSION_SYNC_PERIODS
from ee.bsmart.external_permissions.sync_params import DOC_PERMISSIONS_FUNC_MAP
...
def check_for_doc_permissions_sync(self: Task, *, tenant_id: str | None) -> None:
    ...
    lock_beat = r.lock(
        BsmartRedisLocks.CHECK_CONNECTOR_DOC_PERMISSIONS_SYNC_BEAT_LOCK,
...
def try_creating_permissions_sync_task(
    ...
    lock: RedisLock = r.lock(
        BSMART_REDIS_FUNCTION_LOCK_PREFIX + "try_generate_permissions_sync_tasks",
    ...
    try:
        ...
        result = app.send_task(
            ...
            queue=BsmartCeleryQueues.CONNECTOR_DOC_PERMISSIONS_SYNC,
...
def connector_permission_sync_generator_task(
    ...
    lock = r.lock(
        BsmartRedisLocks.CONNECTOR_DOC_PERMISSIONS_SYNC_LOCK_PREFIX
