...
from bsmart.db.search_settings import get_all_search_settings
from bsmart.redis.redis_connector import RedisConnector
from bsmart.redis.redis_connector_delete import RedisConnectorDeletePayload
...
def check_for_connector_deletion_task(self: Task, *, tenant_id: str | None) -> None:
    ...
    lock_beat: RedisLock = r.lock(
        BsmartRedisLocks.CHECK_CONNECTOR_DELETION_BEAT_LOCK,
