...
from bsmart.configs.app_configs import CELERY_BROKER_POOL_LIMIT
from bsmart.configs.app_configs import CELERY_RESULT_EXPIRES
from bsmart.configs.app_configs import REDIS_DB_NUMBER_CELERY
from bsmart.configs.app_configs import REDIS_DB_NUMBER_CELERY_RESULT_BACKEND
from bsmart.configs.app_configs import REDIS_HEALTH_CHECK_INTERVAL
from bsmart.configs.app_configs import REDIS_HOST
from bsmart.configs.app_configs import REDIS_PASSWORD
from bsmart.configs.app_configs import REDIS_PORT
from bsmart.configs.app_configs import REDIS_SSL
from bsmart.configs.app_configs import REDIS_SSL_CA_CERTS
from bsmart.configs.app_configs import REDIS_SSL_CERT_REQS
from bsmart.configs.constants import BsmartCeleryPriority
from bsmart.configs.constants import REDIS_SOCKET_KEEPALIVE_OPTIONS
...
broker_transport_options = {
    "priority_steps": list(range(len(BsmartCeleryPriority))),
...
task_default_priority = BsmartCeleryPriority.MEDIUM
task_acks_late = True
