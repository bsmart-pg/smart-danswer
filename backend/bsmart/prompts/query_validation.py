...
from bsmart.prompts.constants import GENERAL_SEP_PAT
from bsmart.prompts.constants import QUESTION_PAT
...
{QUESTION_PAT.upper()} Bsmart is unreachable.
```
{THOUGHT_PAT.upper()} The system searches documents related to Bsmart being unreachable. \
Assuming the documents from search contains situations where Bsmart is not reachable and \
