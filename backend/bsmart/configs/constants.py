...
BSMART_METADATA_FILENAME = ".bsmart_metadata.json"

# Messages
DISABLED_GEN_AI_MSG = (
    "Your System Admin has disabled the Generative AI functionalities of Bsmart.\n"
    "Please contact them if you wish to have this enabled.\n"
    "You can still use Bsmart as a search engine."
)
...
# API Keys
BSMART_API_KEY_PREFIX = "API_KEY__"
BSMART_API_KEY_DUMMY_EMAIL_DOMAIN = "bsmartapikey.ai"
...
KV_SETTINGS_KEY = "bsmart_settings"
KV_CUSTOMER_UUID_KEY = "customer_uuid"
KV_INSTANCE_DOMAIN_KEY = "instance_domain"
KV_ENTERPRISE_SETTINGS_KEY = "bsmart_enterprise_settings"
...
BSMART_REDIS_FUNCTION_LOCK_PREFIX = "da_function_lock:"


class DocumentSource(str, Enum):
    # Special case, document passed in via Bsmart APIs without specifying a source type
...
class BsmartCeleryPriority(int, Enum):
    HIGHEST = 0
    HIGH = auto()
    MEDIUM = auto()
    LOW = auto()
