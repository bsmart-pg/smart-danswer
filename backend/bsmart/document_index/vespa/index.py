...
from bsmart.configs.app_configs import DOCUMENT_INDEX_NAME
from bsmart.configs.chat_configs import DOC_TIME_DECAY
from bsmart.configs.chat_configs import NUM_RETURNED_HITS
from bsmart.configs.chat_configs import TITLE_CONTENT_RATIO
from bsmart.configs.chat_configs import VESPA_SEARCHER_THREADS
from bsmart.configs.constants import KV_REINDEX_KEY
from bsmart.context.search.models import IndexFilters
from bsmart.context.search.models import InferenceChunkUncleaned
from bsmart.document_index.interfaces import DocumentIndex
from bsmart.document_index.interfaces import DocumentInsertionRecord
from bsmart.document_index.interfaces import UpdateRequest
from bsmart.document_index.interfaces import VespaChunkRequest
from bsmart.document_index.interfaces import VespaDocumentFields
from bsmart.document_index.vespa.chunk_retrieval import batch_search_api_retrieval
from bsmart.document_index.vespa.chunk_retrieval import (
    get_all_vespa_ids_for_document_id,
)
from bsmart.document_index.vespa.chunk_retrieval import (
    parallel_visit_api_retrieval,
)
from bsmart.document_index.vespa.chunk_retrieval import query_vespa
from bsmart.document_index.vespa.deletion import delete_vespa_docs
from bsmart.document_index.vespa.indexing_utils import batch_index_vespa_chunks
from bsmart.document_index.vespa.indexing_utils import clean_chunk_id_copy
from bsmart.document_index.vespa.indexing_utils import (
    get_existing_documents_from_chunks,
)
from bsmart.document_index.vespa.shared_utils.utils import get_vespa_http_client
from bsmart.document_index.vespa.shared_utils.utils import (
    replace_invalid_doc_id_characters,
)
from bsmart.document_index.vespa.shared_utils.vespa_request_builders import (
    build_vespa_filters,
)
from bsmart.document_index.vespa_constants import ACCESS_CONTROL_LIST
from bsmart.document_index.vespa_constants import BATCH_SIZE
from bsmart.document_index.vespa_constants import BOOST
from bsmart.document_index.vespa_constants import CONTENT_SUMMARY
from bsmart.document_index.vespa_constants import BSMART_CHUNK_REPLACEMENT_PAT
from bsmart.document_index.vespa_constants import DATE_REPLACEMENT
from bsmart.document_index.vespa_constants import DOCUMENT_ID_ENDPOINT
from bsmart.document_index.vespa_constants import DOCUMENT_REPLACEMENT_PAT
from bsmart.document_index.vespa_constants import DOCUMENT_SETS
from bsmart.document_index.vespa_constants import HIDDEN
from bsmart.document_index.vespa_constants import NUM_THREADS
from bsmart.document_index.vespa_constants import SEARCH_THREAD_NUMBER_PAT
from bsmart.document_index.vespa_constants import TENANT_ID_PAT
from bsmart.document_index.vespa_constants import TENANT_ID_REPLACEMENT
from bsmart.document_index.vespa_constants import VESPA_APPLICATION_ENDPOINT
from bsmart.document_index.vespa_constants import VESPA_DIM_REPLACEMENT_PAT
from bsmart.document_index.vespa_constants import VESPA_TIMEOUT
from bsmart.document_index.vespa_constants import YQL_BASE
from bsmart.indexing.models import DocMetadataAwareIndexChunk
from bsmart.key_value_store.factory import get_kv_store
from bsmart.utils.batching import batch_generator
...
class VespaIndex(DocumentIndex):
    ...
    def ensure_indices_exist(
        ...
        vespa_schema_path = os.path.join(
            os.getcwd(), "bsmart", "document_index", "vespa", "app_config"
        )
        schema_file = os.path.join(vespa_schema_path, "schemas", "bsmart_chunk.sd")
        ...
        schema = schema_template.replace(
            BSMART_CHUNK_REPLACEMENT_PAT, self.index_name
        ...
        if self.secondary_index_name:
            upcoming_schema = schema_template.replace(
                BSMART_CHUNK_REPLACEMENT_PAT, self.secondary_index_name
        ...
        if response.status_code != 200:
            raise RuntimeError(
                f"Failed to prepare Vespa Bsmart Index. Response: {response.text}"
            )
    ...
    def register_multitenant_indices(
        ...
        for i, index_name in enumerate(indices):
            ...
            schema = schema_template.replace(
                BSMART_CHUNK_REPLACEMENT_PAT, index_name
        ...
        if response.status_code != 200:
            raise RuntimeError(
                f"Failed to prepare Vespa Bsmart Indexes. Response: {response.text}"
            )
