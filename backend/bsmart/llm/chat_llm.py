...
from bsmart.configs.app_configs import LOG_BSMART_MODEL_INTERACTIONS
from bsmart.configs.model_configs import (
    DISABLE_LITELLM_STREAMING,
)
from bsmart.configs.model_configs import GEN_AI_TEMPERATURE
from bsmart.configs.model_configs import LITELLM_EXTRA_BODY
from bsmart.llm.interfaces import LLM
from bsmart.llm.interfaces import LLMConfig
from bsmart.llm.interfaces import ToolChoiceOptions
from bsmart.server.utils import mask_string
...
class DefaultMultiLLM(LLM):
    ...
    def _invoke_implementation(
        ...
        if LOG_BSMART_MODEL_INTERACTIONS:
    ...
    def _stream_implementation(
        ...
        if LOG_BSMART_MODEL_INTERACTIONS and output:
