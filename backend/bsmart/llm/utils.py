...
from bsmart.configs.model_configs import GEN_AI_MAX_TOKENS
from bsmart.configs.model_configs import GEN_AI_MODEL_FALLBACK_MAX_TOKENS
from bsmart.configs.model_configs import GEN_AI_NUM_RESERVED_OUTPUT_TOKENS
...
from bsmart.prompts.constants import CODE_BLOCK_PAT
...
def translate_bsmart_msg_to_langchain(
...
def translate_history_to_basemessages(
    ...
    history_basemessages = [
        translate_bsmart_msg_to_langchain(msg)
        for msg in history
