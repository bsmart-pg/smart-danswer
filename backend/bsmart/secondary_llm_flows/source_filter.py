...
from bsmart.configs.chat_configs import ENABLE_CONNECTOR_CLASSIFIER
from bsmart.configs.constants import DocumentSource
from bsmart.db.connector import fetch_unique_document_sources
...
from bsmart.natural_language_processing.search_nlp_models import (
    ConnectorClassificationModel,
)
from bsmart.prompts.constants import SOURCES_KEY
from bsmart.prompts.filter_extration import FILE_SOURCE_WARNING
from bsmart.prompts.filter_extration import SOURCE_FILTER_PROMPT
from bsmart.prompts.filter_extration import WEB_SOURCE_WARNING
...
def extract_source_filter(
    ...
    def _get_source_filter_messages(
        ...
        messages = [
            ...
            {
                "role": "user",
                "content": "What page from Bsmart contains debugging instruction on segfault",
            },
            {
                "role": "assistant",
                "content": json.dumps({SOURCES_KEY: None}),
...
if __name__ == "__main__":
    from bsmart.llm.factory import get_default_llms, get_main_llm_from_tuple
