...
from bsmart.db.enums import AccessType, IndexingMode
from bsmart.configs.constants import NotificationType
from bsmart.configs.constants import SearchFeedbackType
from bsmart.configs.constants import TokenRateLimitScope
from bsmart.connectors.models import InputType
from bsmart.db.enums import ChatSessionSharedStatus
...
from bsmart.db.enums import TaskStatus
from bsmart.db.pydantic_type import PydanticType
...
from bsmart.utils.encryption import decrypt_bytes_to_string
from bsmart.utils.encryption import encrypt_string_to_bytes
from bsmart.utils.headers import HeaderItemDict
...
class ConnectorCredentialPair(Base):
    ...
    # {"customer_id": "123567", "company_domain": "@bsmart.ai"}
...
class ChatSession(Base):
    ...
    bsmartbot_flow: Mapped[bool] = mapped_column(Boolean, default=False)
...
These models are only used in Enterprise Edition only features in Bsmart.
They are kept here to simplify the codebase and avoid having different assumptions
on the shape of data being passed around between the MIT and EE versions of Bsmart.

In the MIT version of Bsmart, assume these tables are always empty.
"""
...
class User__ExternalUserGroupId(Base):
    ...
    directly adding the Bsmart user to the doc ACL list"""
