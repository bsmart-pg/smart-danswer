...
from bsmart.db.models import Document
from bsmart.db.models import DocumentByConnectorCredentialPair
from bsmart.db.models import DocumentSet as DocumentSetDBModel
from bsmart.db.models import DocumentSet__ConnectorCredentialPair
from bsmart.db.models import DocumentSet__UserGroup
from bsmart.db.models import User
from bsmart.db.models import User__UserGroup
from bsmart.db.models import UserRole
from bsmart.server.features.document_set.models import DocumentSetCreationRequest
from bsmart.server.features.document_set.models import DocumentSetUpdateRequest
...
def delete_document_set_privacy__no_commit(
    ...
    """No private document sets in Bsmart MIT"""
...
def make_doc_set_private(
    ...
    if user_ids or group_ids:
        raise NotImplementedError("Bsmart MIT does not support private Document Sets")
...
def insert_document_set(
    ...
    try:
        ...
        versioned_private_doc_set_fn = fetch_versioned_implementation(
            "bsmart.db.document_set", "make_doc_set_private"
        )
...
def mark_document_set_as_to_be_deleted(
    ...
    try:
        ...
        versioned_delete_private_fn = fetch_versioned_implementation(
            "bsmart.db.document_set", "delete_document_set_privacy__no_commit"
        )
