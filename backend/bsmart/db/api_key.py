...
from bsmart.auth.api_key import ApiKeyDescriptor
from bsmart.auth.api_key import build_displayable_api_key
from bsmart.auth.api_key import generate_api_key
from bsmart.auth.api_key import hash_api_key
...
from bsmart.db.models import ApiKey
from bsmart.db.models import User
from bsmart.server.api_key.models import APIKeyArgs
from shared_configs.configs import MULTI_TENANT
from shared_configs.contextvars import CURRENT_TENANT_ID_CONTEXTVAR


def get_api_key_email_pattern() -> str:
    return BSMART_API_KEY_DUMMY_EMAIL_DOMAIN
...
def get_api_key_fake_email(
    ...
    return f"{BSMART_API_KEY_PREFIX}{name}@{unique_id}{BSMART_API_KEY_DUMMY_EMAIL_DOMAIN}"
