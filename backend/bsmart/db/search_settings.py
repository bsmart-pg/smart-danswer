...
from bsmart.configs.model_configs import ASYM_PASSAGE_PREFIX
from bsmart.configs.model_configs import ASYM_QUERY_PREFIX
from bsmart.configs.model_configs import DEFAULT_DOCUMENT_ENCODER_MODEL
from bsmart.configs.model_configs import DOC_EMBEDDING_DIM
from bsmart.configs.model_configs import DOCUMENT_ENCODER_MODEL
from bsmart.configs.model_configs import NORMALIZE_EMBEDDINGS
from bsmart.configs.model_configs import OLD_DEFAULT_DOCUMENT_ENCODER_MODEL
from bsmart.configs.model_configs import OLD_DEFAULT_MODEL_DOC_EMBEDDING_DIM
from bsmart.configs.model_configs import OLD_DEFAULT_MODEL_NORMALIZE_EMBEDDINGS
from bsmart.context.search.models import SavedSearchSettings
from bsmart.db.engine import get_session_with_default_tenant
from bsmart.db.llm import fetch_embedding_provider
from bsmart.db.models import CloudEmbeddingProvider
...
from bsmart.server.manage.embedding.models import (
...
def get_new_default_search_settings(is_present: bool) -> SearchSettings:
    return SearchSettings(
        ...
        index_name=f"bsmart_chunk_{clean_model_name(DOCUMENT_ENCODER_MODEL)}",
    )
