...
from bsmart.db.feedback import delete_document_feedback_for_documents__no_commit
...
from bsmart.db.tag import delete_document_tags_for_documents__no_commit
from bsmart.db.utils import model_to_dict
...
def get_access_info_for_documents(
    ...
    - List of emails of Bsmart users with direct access to the doc (includes a "None" element if
