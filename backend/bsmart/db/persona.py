...
from bsmart.db.models import Persona__UserGroup
from bsmart.db.models import PersonaCategory
from bsmart.db.models import Prompt
from bsmart.db.models import StarterMessage
from bsmart.db.models import Tool
from bsmart.db.models import User
from bsmart.db.models import User__UserGroup
from bsmart.db.models import UserGroup
...
def make_persona_private(
    ...
    if group_ids:
        raise NotImplementedError("Bsmart MIT does not support private Personas")
...
def create_update_persona(
    ...
    try:
        ...
        versioned_make_persona_private = fetch_versioned_implementation(
            "bsmart.db.persona", "make_persona_private"
        )
...
def validate_persona_tools(tools: list[Tool]) -> None:
    for tool in tools:
        if tool.name == "InternetSearchTool" and not BING_API_KEY:
            raise ValueError(
                "Bing API key not found, please contact your Bsmart admin to get it added!"
            )
