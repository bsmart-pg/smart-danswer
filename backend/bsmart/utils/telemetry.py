...
from bsmart.configs.app_configs import ENTERPRISE_EDITION_ENABLED
from bsmart.configs.constants import KV_CUSTOMER_UUID_KEY
from bsmart.configs.constants import KV_INSTANCE_DOMAIN_KEY
...
_BSMART_TELEMETRY_ENDPOINT = "https://telemetry.bsmart.ai/anonymous_telemetry"
...
def optional_telemetry(
    ...
    try:
        ...
        # Should never interfere with normal functions of Bsmart
        pass
