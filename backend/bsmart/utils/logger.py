...
class BsmartLoggingAdapter(logging.LoggerAdapter):
    def process(
...
BSMART_DOCKER_ENV_STR = "BSMART_RUNNING_IN_DOCKER"


def is_running_in_container() -> bool:
    return os.getenv(BSMART_DOCKER_ENV_STR) == "true"
