...
from model_server.bsmart_torch_model import ConnectorClassifier
from model_server.bsmart_torch_model import HybridClassifier
...
def warm_up_connector_classifier_model() -> None:
    ...
    input_ids, attention_mask = tokenize_connector_classification_query(
        ["GitHub"],
        "bsmart classifier query google doc",
