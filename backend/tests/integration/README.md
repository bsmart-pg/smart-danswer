...
1. Launch bsmart (using Docker or running with a debugger), ensuring the API server is running on port 8080.
    a. If you'd like to set environment variables, you can do so by creating a `.env` file in the bsmart/backend/tests/integration/ directory.
2. Navigate to `bsmart/backend`.
