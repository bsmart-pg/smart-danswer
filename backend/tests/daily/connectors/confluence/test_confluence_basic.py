...
def test_confluence_connector_basic(
    ...
    assert page_within_a_page_doc.primary_owners[0].email == "hagen@bsmart.ai"
    ...
    assert (
        ...
        == "https://bsmartai.atlassian.net/wiki/spaces/DailyConne/pages/200769540/Page+Within+A+Page"
    )
    ...
    assert page_doc.primary_owners[0].email == "hagen@bsmart.ai"
    ...
    assert (
        page_section.link
        == "https://bsmartai.atlassian.net/wiki/spaces/DailyConne/overview"
    )
    ...
    assert txt_doc.primary_owners[0].email == "chris@bsmart.ai"
    assert (
        txt_doc.sections[0].link
        == "https://bsmartai.atlassian.net/wiki/pages/viewpageattachments.action?pageId=52494430&preview=%2F52494430%2F52527123%2Fsmall-file.txt"
    )
