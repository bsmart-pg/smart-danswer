...
The base instructions to set up the development environment are located in [CONTRIBUTING.md](https://github.com/bsmart-ai/bsmart/blob/main/CONTRIBUTING.md).
