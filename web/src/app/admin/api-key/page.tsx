...
import { BsmartApiKeyForm } from "./BsmartApiKeyForm";
import { APIKey } from "./types";

const API_KEY_TEXT = `API Keys allow you to access Bsmart APIs programmatically. Click the button below to generate a new API Key.`;
