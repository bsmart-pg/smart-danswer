      ...
      {isEnterpriseEnabled && (
        <>
          ...
          <IntegerInput
            ...
            sublabel="Enter the maximum number of days you would like Bsmart to retain chat messages. Leaving this field empty will cause Bsmart to never delete chat messages."
