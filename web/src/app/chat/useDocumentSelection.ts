...
export function useDocumentSelection(): [
  BsmartDocument[],
  (document: BsmartDocument) => void,
  () => void,
  number,
] {
  const [selectedDocuments, setSelectedDocuments] = useState<BsmartDocument[]>(
    []
  );
  ...
  function toggleDocumentSelection(document: BsmartDocument) {
