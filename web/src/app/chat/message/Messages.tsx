...
export const AIMessage = ({
  ...
  files?: FileDescriptor[];
  query?: string;
  citedDocuments?: [string, BsmartDocument][] | null;
  ...
  setPresentingDocument?: (document: BsmartDocument) => void;
}) => {
  ...
  let filteredDocs: FilteredBsmartDocument[] = [];
  ...
  if (docs) {
    filteredDocs = docs
      ...
      .map((doc: BsmartDocument, ind: number) => {
        return {
          ...doc,
